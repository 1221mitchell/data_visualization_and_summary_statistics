...
def all_corr_heatmap(data, title, size_var = 18):
    # set size_var as a parameter with a default of 18
    plt.figure(figsize=(10,6))
    # abstract title as parameter
    plt.title(title, fontsize = size_var, pad = size_var / 2)
...
def one_corr_heatmap(data, target_variable, title, x_label, size_var = 18):
    # set size_var as a parameter with a default of 18
    plt.figure(figsize=(4,10))
    # abstract title as parameter
    plt.title(title, fontsize = size_var, pad = size_var / 2)
    
    sns.heatmap(data.corr()[[target_variable]], cmap='coolwarm')
